...
export default function JanelaChat() {
    const { mensagens, adicionarMensagem, limparMensagens, pensando } = useChat()
    ...
    return (
        <div className="flex flex-col bg-zinc-300 rounded-2xl text-black overflow-hidden h-full">
            ...
            <div className="flex items-center gap-2 p-1 m-4 rounded-full h-10 bg-white">
                ...
                />
                <button className="flex justify-center items-center min-h-8 min-w-8 rounded-full bg-red-500"
